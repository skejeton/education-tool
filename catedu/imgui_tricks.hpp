...
struct ImGuiTricks {
    ...
    /// @brief To be called before placing any widget, and used as a window container.
    /// @description This function is designed to be used as a regular ImGui window as a container.
    ...
    ///        If you have a list of generated windows with same ID, use this function.
    ...
    /// @description Creates a place where you can safely call ImGUI widget calls.
    /// @param rect the widget rectangle.
