...
static Matrix4
pivoted_at(Matrix4 mat, Matrix4 parent, Vector2 pivot)
{
...
Matrix4
UiTransform::calculate_matrix(Vector2 screen_size)
{
...
void
UiTransform::stack(UiTransform previous)
{
...
UiTransformer
UiTransformer::init(UiRenderingCore* core, Vector2 screen_size)
{
...
void
UiTransformer::push(UiTransform transform)
{
...
Vector2
UiTransformer::transform_point(Vector2 point)
{
