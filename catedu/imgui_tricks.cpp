...
static Rect
begin_general_window(ImGuiTricks* tricks,
                     Rect rect,
                     const char* name,
                     ImGuiWindowFlags flags)
{
    ...
    return rect_from_min_max({ content_min.x, content_min.y },
                             { content_max.x, content_max.y });
}

Rect
ImGuiTricks::begin_window(Rect rect, const char* title)
{
    return begin_general_window(this, rect, title, ImGuiWindowFlags_None);
}

void
ImGuiTricks::begin_widget(Rect rect, const char* id)
{
    begin_general_window(this,
                         rect,
                         id,
