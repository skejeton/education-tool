...
#pragma region taxist_a
    ...
    SCRIPT("taxist_a5", any)
    {
        scr.activate_dialog = true;
        scr.dialog = {
            "Taxista", "Vamos la!", "Let’s go!", {{"Go", "taxist_a6"}}};
    }
    ...
    {
        scr.activate_dialog = true;
        scr.dialog = {"Lexi", "Crédito!", "Credit!", {{"Next", "taxist_a8"}}};
    }
...
#pragma region walter
    ...
    {
        scr.activate_dialog = true;
        scr.dialog = {"Lexi", "Walter?", "", {{"Next", "walter2"}}};
    }
    SCRIPT("walter2", any)
    {
        scr.activate_dialog = true;
    ...
    SCRIPT("walter6", any)
    {
        scr.activate_dialog = true;
        scr.dialog = {
            "Lexi", "Aqui está!", "Here you go!", {{"Next", "walter7"}}};
    }
    SCRIPT("walter7", any)
    {
        scr.data[1] = 1;
...
#pragma region atmex
    ...
    SCRIPT("atmex2", any)
    {
        ...
        scr.dialog = {
            ...
            "",
            {{"R$100", scr.currency < 41500 ? "broke" : "atmex100"},
             {"R$500", scr.currency < 207500 ? "broke" : "atmex500"},
             {"Close", nullptr}}};
    }
    SCRIPT("atmex100", any)
    {
...
#pragma region atmchp
    ...
    SCRIPT("atmchp2", any)
    {
        ...
        scr.dialog = {
            ...
            "",
            {{"R$100", scr.currency < 30000 ? "broke" : "atmchp100"},
             {"R$500", scr.currency < 150000 ? "broke" : "atmchp500"},
             {"Close", nullptr}}};
    }
...
#pragma region tehchnical
    ...
    SCRIPT("broke", any)
    {
        scr.dialog = {"Lexi", "(Maybe later)", "", {{"Close", nullptr}}};
        scr.activate_dialog = true;
    }
