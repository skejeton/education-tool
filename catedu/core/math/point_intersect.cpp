...
{
    return quintic_superellipse_intersect_point(2, radii.x, radii.y, point - center);
}

bool math_point_intersect_squircle(Vector2 point, Rect rect, float n)
{
    return quintic_superellipse_intersect_point(n, rect.siz.x/2, rect.siz.y/2, point - rect.pos - rect.siz/2.0);
}
