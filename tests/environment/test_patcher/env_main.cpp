...
int main()
{
    ...
    Player example_player_2 = {
        {4, 5, 6},
        "Bob"
    };

    printf("%d %d %d %s\n", example_player.position[0], example_player.position[1], example_player.position[2], example_player.name);
    printf("%d %d %d %s\n", example_player_2.position[0], example_player_2.position[1], example_player_2.position[2], example_player_2.name);
