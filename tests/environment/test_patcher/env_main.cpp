...
void
patch_player_pos(Patcher* patcher, void* player_)
{
...
void
patch_player(Patcher* patcher, void* player_)
{
    Player* player = (Player*)player_;
...
main()
{
    ...
    printf("%d %d %d %s\n",
           ...
           example_player.position[1],
           example_player.position[2],
           example_player.name);
    printf("%d %d %d %s\n",
           example_player_2.position[0],
           example_player_2.position[1],
           example_player_2.position[2],
